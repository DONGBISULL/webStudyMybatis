...
@WebServlet(value="/index.do",loadOnStartup=1)// 제일 최초에 객체 생성
public class indexServlet extends HttpServlet {
	...
	@Override 
		public void init(ServletConfig config) throws ServletException {
			...
			try (
			InputStream is = getClass().getResourceAsStream("/kr/or/ddit/serviceInfo.xml");
			){
...
map.put("STANDARD" , "/02/standard.jsp");
map.put("CALENDAR" , "/04/calendar.jsp");
